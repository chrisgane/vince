            ...
            <Container wider expandHeight={false}>
                <div className="grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-20 py-20">
                    ...
                    <div data-aos="fade-up">
                        ...
                        <div>
                            <p className={"text-base"}>
                                Vince is always looking for exceptional
                                individuals in the field of content creation;
                                producers, directors, dops and mograph ops - so
                                why not give us a shout at{" "}
                                <Obfuscate email="haveword@vince.co.uk" /> with
                                your cover letter and CV. Thanks!
                            </p>
                        </div>
                    </div>
                    <div data-aos="fade-up">
                ...
                <div className="bottom-info bg-black flex flex-col lg:flex-row items-center justify-center border-t border-gray-900 py-3">
                    ...
                    <p className="mx-10 text-center">
                        © Copyright {fullYear()}. VINCE MEDIA Ltd. No. 07708529.
                        All rights reserved.
                    </p>
